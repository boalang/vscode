...
export const builtinEnums: { [name: string]: IEnum } = {
    ...
    ModifierKind: {
        attrs: [
			...
			{ name: 'FINAL', doc: 'A final modifier' },
			{ name: 'OTHER', doc: 'Any other modifier - the value is in the Modifier\'s `other` attribute' },
			{ name: 'STATIC', doc: 'A static modifier' },
			{ name: 'SYNCHRONIZED', doc: 'A synchronized modifier' },
			{ name: 'VISIBILITY', doc: 'A Modifier\'s `visibility` attribute' },
        ],
        doc: 'The kind of modifier.',
    },
    Visibility: {
        attrs: [
			{ name: 'NAMESPACE', doc: 'A namespace (aka, default, aka package) visibility modifier' },
			{ name: 'PRIVATE', doc: 'A private modifier' },
			{ name: 'PROTECTED', doc: 'A protected modifier' },
			{ name: 'PUBLIC', doc: 'A public modifier' },
        ],
